...
import de.rafaelbeckmann.hvkclient.AlarmItem
...
fun SettingsScreen(
    ...
    LazyColumn(
        ...
        if (isDeveloper) {
            ...
            // TODO ES WIRD BEI NEUSTART GELÖSCHT https://developer.android.com/develop/background-work/services/alarms/schedule
            item{
                Column(
                    modifier = Modifier
                        .fillMaxSize(),
