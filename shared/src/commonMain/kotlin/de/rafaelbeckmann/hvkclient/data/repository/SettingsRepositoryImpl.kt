...
class SettingsRepositoryImpl(
    ...
    override suspend fun setAccessToken(token: String) {
        ...
        println("Access token set: $token")
    }

    override suspend fun getAccessToken(): String? {
        println("Access token retrieved: ${prefUtils.getString(PreferenceKeys.ACCESS_TOKEN)}")
        return prefUtils.getString(PreferenceKeys.ACCESS_TOKEN)
    }

    override suspend fun setRefreshToken(token: String) {
        prefUtils.saveString(PreferenceKeys.REFRESH_TOKEN, token)
        println("Refresh token set: $token")
    }

    override suspend fun getRefreshToken(): String? {
        println("Refresh token retrieved: ${prefUtils.getString(PreferenceKeys.REFRESH_TOKEN)}")
